...
<!--                <a href="index.jsp">
                ...
                <!-- img based logo -->
                <a href="${pageContext.request.contextPath}/"><img src="${url}/images/TheLoaiXe/d3ss.png" alt="logo img" width="100%"></a> 
              </div>
              <!-- / logo  -->
              <!-- Shipping service -->
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <c:forEach items="${order.items}" var="item" >
                    <li>
                      <a class="aa-cartbox-img" href="${pageContext.request.contextPath}/view/client/cart"><img src="${pageContext.request.contextPath}/view/client/assets/images/TheLoaiXe/${item.product.image_link}" alt="img"></a>
